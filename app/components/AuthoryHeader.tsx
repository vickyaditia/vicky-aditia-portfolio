          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            <div className="relative w-28 h-28 sm:w-32 sm:h-32 rounded-full p-1 bg-gradient-to-tr from-emerald-500 via-slate-600 to-emerald-400 shrink-0 shadow-xl shadow-emerald-500/20">
              <div className="w-full h-full rounded-full overflow-hidden relative border-2 border-slate-900 bg-slate-900">
                <Image
                  ...
                  fill
                  className="object-cover object-[center_15%] hover:scale-105 transition-transform duration-300"
                  priority
                />
              </div>
            ...
            <div className="space-y-2">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full bg-emerald-500/20 border border-emerald-500/40 text-emerald-300 text-xs font-mono font-medium backdrop-blur-md">
